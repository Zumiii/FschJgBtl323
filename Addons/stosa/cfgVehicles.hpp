class TargetBootcampHuman_F;
  ...
  class GVAR(Stuermender_Schuetze): TargetBootcampHuman_F {
    ...
    class EventHandlers {
			class zumis_zusatz {
				init = "params ['_scheibe']; _scheibe setObjectTextureGlobal [0, 'z\fjb_323\addons\stosa\data\stuermender_schuetze_v3.paa']; [_scheibe] call zumi_fnc_scheibe_init; [_scheibe] call zumi_fnc_klappziele_init;";
