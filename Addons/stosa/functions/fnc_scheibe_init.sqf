...
//Interaktionen
_scheibensteuerung = ["Scheibensteuerung","Scheibensteuerung","\A3\ui_f\data\igui\cfg\simpleTasks\types\whiteboard_ca.paa",{},{true},{},[],_offset, 5] call zumi_fnc_interaction_create;
...
switch (TypeOf _scheibe) do {
  case "TargetBootcampHumanSimple_F" : {
    ...
    },{!((_target getVariable ["runtergeklappt", 0]) < 1)},{},[_scheibe],[0,0,0], 2] call zumi_fnc_interaction_create;
  ...
  case "stuermender_schuetze" : {
    ...
    _abklappen_nach = ["abklappen_nach","Treffer nötig: ","\A3\ui_f\data\igui\cfg\simpleTasks\types\use_ca.paa",{},{true},{},[],[0,0,0], 5] call zumi_fnc_interaction_create;
    ...
    },{!((_target getVariable ["hits_required", 1]) == 1)},{},[_scheibe],[0,0,0], 2] call zumi_fnc_interaction_create;
    ...
    },{!((_target getVariable ["hits_required", 1]) == 2)},{},[_scheibe],[0,0,0], 2] call zumi_fnc_interaction_create;
    ...
    },{!((_target getVariable ["hits_required", 1]) == 3)},{},[_scheibe],[0,0,0], 2] call zumi_fnc_interaction_create;
    ...
    },{!((_target getVariable ["hits_required", 1]) == 4)},{},[_scheibe],[0,0,0], 2] call zumi_fnc_interaction_create;
...
},{((count (attachedObjects _target)) > 0)},{},[_scheibe],[0,0,0], 2] call zumi_fnc_interaction_create;
...
},{(count (attachedObjects _target) > 0) && (({isObjectHidden _x} count (attachedObjects _target)) > 0)},{},[_scheibe],[0,0,0], 2] call zumi_fnc_interaction_create;

if (_steuerung != _scheibe) then {
  _trefferbild = ["Trefferbild","Trefferbild","\A3\ui_f\data\igui\cfg\simpleTasks\types\target_ca.paa",{},{true},{},[],[0,0,0], 5] call zumi_fnc_interaction_create;
...
},{isNull (_target getVariable ["ace_common_owner", objNull])},{},[_scheibe, _steuerung],[0,0,0], 2] call zumi_fnc_interaction_create;
...
},{!(isNull (_target getVariable ["ace_common_owner", objNull]))},{},[_scheibe],[0,0,0], 2] call zumi_fnc_interaction_create;
...
_abmelden_alle = ["Abmelden_alle","Überall abmelden","\A3\ui_f\data\igui\cfg\simpleTasks\types\interact_ca.paa",{
  ...
  /*
  private _owner = (_s getVariable ["ace_common_owner", objNull]);
  ["zumi_stosa_bahn", [], _owner] call CBA_fnc_targetEvent;
  */
...
},{!(isNull (_target getVariable ["ace_common_owner", objNull])) && ((count stosa_bahn) > 1)},{},[_scheibe],[0,0,0], 2] call zumi_fnc_interaction_create;
