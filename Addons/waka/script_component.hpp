#define COMPONENT waka
#define COMPONENT_BEAUTIFIED WaKa
#include "\z\fjb_323\addons\main\script_mod.hpp"
#include "\z\fjb_323\addons\main\script_macros.hpp"

#define WAFFENKAMMER [
	[
    ["Loadouts", "\A3\ui_f\data\map\markers\flags\Germany_ca.paa"],
